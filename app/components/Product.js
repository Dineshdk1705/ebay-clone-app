  ...
  return (
    <>
      <Link
        ...
        className="max-w-[200px] p-1.5 border border-gray-50 transform transition duration-500 hover:scale-110 hover:border-gray-200 hover:shadow-xl bg-gray-100 rounded mx-auto"
      >
        {product?.url ? (
